...
const ImageText = styled.h2`
  ...
  transition: 0.5s cubic-bezier(.645,.045,.355,1) all 1s;
  ...
  .willClose & {
    transform: translateX(-100%);
    transition: 0.5s cubic-bezier(.645,.045,.355,1) all 0.2s;
...
const ImageContent = styled.h2`
  ...
  color: white;
  transform: translateX(-100%);
  transition: 0.5s cubic-bezier(.645,.045,.355,1) all ${props => props.delay || '1s'};
...
const ImagesWrapper = styled.div`
  ...
  opacity: 1;
  pointer-event: none;
  transition: 1s cubic-bezier(.645,.045,.355,1) width, 1s left cubic-bezier(.645,.045,.355,1) 0.1s, 1s transform cubic-bezier(.645,.045,.355,1) 0.1s;
  transform: translateX(0%)
...
const ImageContainer = styled.div`
  ...
  &:before {
    ...
    background: white;
    z-index: 2;
    transition: 1s cubic-bezier(.645,.045,.355,1) all 0s;
    // transition: 1s all cubic-bezier(.645,.045,.355,1) ${props => props.delay || '1s'};
    transform: translatex(0%);
...
const Image = styled.div`
  ...
  id: ${props => props.id};
  // transition: 1s all cubic-bezier(.645,.045,.355,1) ${props => props.delay || 1}s;
  transition: 0.8s all cubic-bezier(.645,.045,.355,1) ${props => props.delay}s,  opacity 0.5s cubic-bezier(.645,.045,.355,1) 0.5s;
  ...
  .table & {
    ...
    width: 300%;
    height: 300%;
    transition: 0.8s all cubic-bezier(.645,.045,.355,1) ${props => props.delay + 1}s , opacity 0.5s cubic-bezier(.645,.045,.355,1);
